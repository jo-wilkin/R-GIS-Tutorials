...
```{r Check the structure of our data frame}
...
```{r Subset our data to only London schools}
...
```{r Determine if there are NA values}
...
```{r Export address dataset to csv for manual editing}
...
```{r Map geocoded schools to check spatial accuracy}
